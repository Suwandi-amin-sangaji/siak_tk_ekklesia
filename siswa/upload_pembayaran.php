        ...
        <div class="col-sm-10 offset-sm-1">
            <form class="uploadbukti my-1" action="aksi_uploadbukti.php" enctype="multipart/form-data" method="POST">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nasabah" name="nasabah" placeholder="Nama No.Rek"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="date" class="form-control" id="tgl_pembayaran" name="tgl_pembayaran"
                            placeholder="Tanggal Melakukan Pembayaran" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nama_siswa" name="nama_siswa"
                            placeholder="Wali murid dari" required>
                    </div>
                </div>
                <div class="form-group row">
