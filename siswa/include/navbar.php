                    ...
                    <div class="horizontal-menu">
                        <nav>
                            <ul id="nav_menu">
                                ...
                                <li class="active">
                                    <a href="javascript:void(0)"><i class="ti-layout-sidebar-left"></i><span>Akademik</span></a>
                                    <ul class="submenu">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><i class="ti-layout-sidebar-left"></i><span>Pendaftaran</span></a>
                                    <ul class="submenu">
                                        <?php
                                        // include "koneksi.php";
