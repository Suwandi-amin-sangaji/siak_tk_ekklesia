                    ...
                    <form class="needs-validation" novalidate="">
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="" placeholder="No Induk"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" aria-describedby="inputGroupPrepend"
                                        value="<?php echo $data['no_telp']; ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" aria-describedby="inputGroupPrepend"
                                        value="<?php echo $data['tgl_pendaftaran']; ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                        ...
                        <a class="btn btn-danger" type="submit" href="dash_siswa.php">Kembali</a>
                    </form>
                    <?php } ?>
                </div>
            </div>
