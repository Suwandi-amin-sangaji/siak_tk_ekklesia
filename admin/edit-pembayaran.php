...
<div class="col-12">
    <div class="card mt-5">
        <div class="card-body">
            <h4 class="header-title">Update Pembayaran</h4>
            <div class="row my-5">
                <div class="col-sm-10 offset-sm-1">
                    ...
                    <form method="POST" action="update-pembayaran.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nasabah" name="nasabah"
                                    value="<?php echo $data['nasabah'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="tgl_pembayaran" name="tgl_pembayaran"
                                    value="<?php echo $data['tgl_pembayaran'] ?>">
                            </div>
                        </div>
                        <div class=" form-group row">
