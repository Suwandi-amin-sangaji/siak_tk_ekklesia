    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="aksi-siswa.php" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label for="nama_lengkap" class="col-sm-3 col-form-label">0. Nama Lengkap :</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="nama_lengkap" class="col-sm-3 col-form-label">1. Username :</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="pend_terakhir_ayah" class="col-sm-3 col-form-label">11. Pendidikan Terakhir
                            Ayah:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="pend_terakhir_ayah" name="pend_terakhir_ayah"
                                placeholder="Pendidikan terakhir Ayah" required />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="pend_terakhir_ibu" class="col-sm-3 col-form-label">12. Pendidikan Terakhir Ibu
                            :</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="pend_terakhir_ibu" name="pend_terakhir_ibu"
                                placeholder="Pendidikan Terakhir ibu" required />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="telp" name="telp" placeholder="Nomor Telephone"
                                required />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="tapel" name="tapel" placeholder="Tahun Ajaran"
                                required />
                    ...
                    <div class="buttom col-sm-12 my-5">
                        ...
                        <div class="kelompok mt-5 text-center my-3">
                            <button type="submit" class="btn btn-warning" id="kirim" name="kirim"
                                value="kirim">Daftar</button>
                        </div>
                    </div>
                </form>
            </div>
